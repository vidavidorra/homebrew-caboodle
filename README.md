...
[![License](https://img.shields.io/github/license/vidavidorra/homebrew-caboodle.svg?style=flat-square)](LICENSE.md)
...
Please [create an issue](https://github.com/vidavidorra/homebrew-caboodle/issues/new/choose) if you have a bug report, feature proposal or question that does not yet exist.
...
[![Lint commit messages](https://img.shields.io/github/workflow/status/vidavidorra/homebrew-caboodle/Lint%20commit%20messages?logo=github&label=Lint%20commit%20messages&style=flat-square)](https://github.com/vidavidorra/homebrew-caboodle/actions)
[![Build](https://img.shields.io/github/workflow/status/vidavidorra/homebrew-caboodle/Build?logo=github&label=Build&style=flat-square)](https://github.com/vidavidorra/homebrew-caboodle/actions)

## Security policy

Please refer to the [Security Policy on GitHub](https://github.com/vidavidorra/homebrew-caboodle/security/) for the security policy.
